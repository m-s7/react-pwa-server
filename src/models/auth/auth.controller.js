...
var local_guard_1 = require("./strategies/local.guard");
var refresh_token_guard_1 = require("./strategies/refresh-token.guard");
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.refreshTokens = function (req) {
        var _a;
        var user = req.user;
        if (!user)
            throw new common_1.UnauthorizedException();
        var id = user.sub;
        var refreshToken = (_a = req
